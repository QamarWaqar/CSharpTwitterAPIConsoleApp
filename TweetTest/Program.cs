...
namespace TweetTest
{
    class Program
    {
        ...
        public static void gettingToken(string consumerKey, string consumerSecret)
        {
            ...
            System.Diagnostics.Debug.WriteLine("Access Token = " + newCredentials.AccessToken); System.Diagnostics.Debug.WriteLine("Access Token Secret = " + newCredentials.AccessTokenSecret);
        }
    }
}
